...
data class SearchResultDataItem(
  ...
  val license: SearchResultDataLicence?,
  ...
  val searchResultOwner: SearchResultDataOwner?,
...
class SearchResultItemEntityMapper(
  private val searchLicenseEntityMapper: SearchLicenseEntityMapper,
  private val searchOwnerEntityMapper: SearchOwnerEntityMapper
) :
  EntityMapper<SearchResultDomainItem, SearchResultDataItem> {
  override fun mapToDomain(entity: SearchResultDataItem): SearchResultDomainItem {
    return SearchResultDomainItem(
      ...
      license = entity.license?.let { searchLicenseEntityMapper.mapToDomain(it) },
      ...
      score = entity.score,
      owner = entity.searchResultOwner?.let { searchOwnerEntityMapper.mapToDomain(it) },
      size = entity.size,
